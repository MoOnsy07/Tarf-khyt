...
const CASE_NO_WITNESS_NIGHT = {
  ...
  endings: {
    good: {
      stamp:'JUSTICE', badgeLabel:'CASE CLOSED — JUSTICE SERVED', title:'البراءة والحقيقة مع بعض',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: سجل صيانة الكاميرا، اعتراف كريم بالخناقة، وتصحيح التوقيت، قبل ما تقدّم الاتهام النهائي.'
    },
    bad: {
