    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنها مديرة الإنتاج وده يكفي كدافع، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأن وليد هو المتهم الأصلي وده أوضح مشتبه فيه، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كانت بتحاول تحمي رنا من وليد فعليًا، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'كانت بتخطط لإيذاء رنا من البداية، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
    ],
