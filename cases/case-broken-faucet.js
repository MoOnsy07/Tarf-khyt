...
const CASE_BROKEN_FAUCET = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه أحد الورثة وده يكفي كدافع، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأن نعيم هو اللي فتح الفيلا لعادل، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'عادل كان بيسرق المستندات بنفسه لصالح طرف تالت، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'نعيم الحارس هو اللي وجّه عادل للغرفة عمدًا، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'الصنبور اللي كشف عن غرفة مخفية',
      paragraphs:[
...
(() => {
  ...
  c.endings.partial.hint = 'اجمع على الأقل 4 أدلة من: نزاع الميراث، مستندات الغرفة، ومسار يوسف للغرفة المقفولة، قبل ما تتهم.';
