...
const CASE_LOST_WALLET = {
  ...
  suspects: [
    {
      ...
      confrontations:{
        wallet_access:'مالك هو بس اللي معاه المفتاح، أنا ماكنش ليّا دخل بالتحويلات.',
        early_exit:'حازم كان مستثمر أول فعلاً، بس أنا ماديتلوش أي معلومة سرية.'
      }
    },
    {
      ...
      confrontations:{
        wallet_access:'أنا معايا المفتاح فعلاً، بس ده عشان دوري التقني، مش معناه إني سرقت.',
        private_key_log:'معرفش إزاي اتسجل التوقيع ده باسمي، أنا ماوقعتش على حاجة.',
        early_exit:'حازم عرف عن المشروع من عمر، مش مني أنا.',
        external_wallet_id:'الحساب ده مش حساب أعرفه، ممكن يكون حد استخدم اسمي.',
        contradiction_noted_wallet:'ممكن أكون دخلت النظام، بس مش زي ما إنتوا فاكرين خالص.'
      }
    },
    {
      ...
      confrontations:{
        reem_no_access:'أنا دوري تسويقي بحت، مالوش أي علاقة بالمحفظة أو الفلوس.'
      }
    },
    {
      ...
      confrontations:{
        wallet_access:'مالك هو بس اللي معاه المفتاح، أنا ماكنش عندي أي وصول تقني.',
        early_exit:'أنا مستثمر أول فعلاً، بس معرفتيش دي جتلي من عمر ومالك مش سرقة.',
        hazem_withdrawal:'سحبت استثماري لأسباب شخصية، حسيت إن فيه حاجة مش مطمنة.'
      }
    },
  ],
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه الشريك التقني وده كافي وحده، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأنه ماردش على مكالمات يوسف، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه الوجه العام وده بيبعده عن الشبهة، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'لأنه اعترف بمكانه بس، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'الخيط الرقمي وصل لصاحبه',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل 4 أدلة من: سجلات النظام، سحب حازم، والحساب الخارجي، قبل ما تتهم.'
    },
    bad: {
