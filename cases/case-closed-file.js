...
const CASE_CLOSED_FILE = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الملف اللي رفض يفضل مغلق',
      paragraphs:[
    ...
    bad: {
      stamp:'UNSOLVED', badgeLabel:'CASE CLOSED — WRONGFUL ACCUSATION', title:'القضية اتقفلت غلط تاني',
      paragraphs:[
