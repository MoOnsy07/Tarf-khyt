    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأن أبوه كان المشتبه به الأساسي وده يكفي، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأن ناصر كان أكتر مستفيد من إغلاق القضية، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان مخطط للقتل من البداية عشان يحمي أبوه، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'كان بيحاول يساعد فتحي في التحقيق فعليًا، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
