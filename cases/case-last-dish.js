...
const CASE_LAST_DISH = {
  ...
  suspects: [
    {
      ...
      confrontations:{
        motive_note:'أنا مالوش أي مصلحة في موت تامر، ده كان هيحكم لصالحي أصلاً.',
        oil_bottle_moved:'الزجاجة دي اتحركت، بس أنا معرفش مين اللي حركها.'
      }
    },
    {
      ...
      confrontations:{
        poison_report:'معرفش إزاي المادة دي دخلت الصلصة، أنا ماحطتش حاجة فيها.',
        contract_dispute:'الخلاف على العقد كان موجود، بس ده ملوش علاقة بموته.',
        fridge_log:'دخلت الثلاجة آخد مكون بس، حاجة عادية في شغلي.',
        kitchen_access:'المطبخ كان مفتوح للجميع، مش أنا بس اللي كنت فيه.',
        noha_prints:'بصمتي على الزجاجة لأني مسكتها وأنا بنضف المطبخ، مش أكتر من كده.',
        contradiction_noted_lastdish:'دخلت الثلاجة فعلاً، بس نسيت أذكرها لأنها حاجة عادية جدًا.'
      }
    },
    {
      ...
      confrontations:{
        yehia_seen_far:'أنا كنت في الجمهور طول الوقت، شهود كتير شافوني هناك.'
      }
    },
    {
      ...
      confrontations:{
        fridge_log:'أنا بس متابع دخول وخروج الثلاجة، مش مسؤول عن اللي بيتحط فيها.',
        oil_bottle_moved:'أنا شايل زجاجات كتير كل يوم، ممكن أكون حركتها من غير قصد.'
      }
    },
    {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنها كانت قاعدة جنبه وقت ما وقع، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأنها بكت لما اتسألت، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'الغيرة من نجاح عادل، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'مفيش دافع واضح خالص، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'السم كان في اللمسة الأخيرة',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل 4 أدلة من: سجل دخول الثلاجة، بصمات الزيت، والخلاف على العقد، قبل ما تتهم.'
    },
    bad: {
