...
const CASE_DATING_APP = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه الشخص اللي قابلته من التطبيق وده يكفي، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأن حازم كان بيحبها وده أوضح دافع، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان صديق قديم لمايا بيتنكر عمدًا، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'كان بيحاول يحميها من خطر تاني، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إنقاذ', title:'كاميرا خارج المقهى كشفت التتبع',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: البروفايل المزيف، ملاحظة صاحب المقهى، وكاميرا التتبع، قبل ما تتهم.'
    },
    bad: {
