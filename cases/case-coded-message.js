...
const CASE_CODED_MESSAGE = {
  ...
  /* ============================================================
     ...
     الرسالة بتستخدم ترقيم الحروف العربية بالترتيب:
     ا=1، ب=2، ت=3... ي=28، واللاعب يحول كل رقم
     إلى حرفه عشان يوصل لنوع مكان احتجاز نور.
     ============================================================ */
  cipherPuzzle: {
    enabled: true,
    tabLabel: 'فك الشفرة',
    introText: 'كل رقم بيمثل ترتيب حرف في الأبجدية العربية: ا=1، ب=2، ت=3، ث=4... لحد ي=28. حوّل كل رقم إلى حرفه واقرأ الكلمتين، ثم اكتب العبارة كاملة.',
    cipherText: '24-7-11-25 / 20-28-23-1',
    cipherKey: 'ا=1 ... ي=28',
    solutionText: 'مخزن فيلا',
    resultText: 'فكيت الشفرة! العبارة هي "مخزن فيلا" — لسه لازم تربط المكان بشهادة سعاد قبل التحرك.',
