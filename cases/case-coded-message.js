...
const CASE_CODED_MESSAGE = {
  ...
  /* ============================================================
     ...
     الرسالة بتستخدم ترقيم الحروف الإنجليزية بالترتيب:
     A=1, B=2, ... Z=26، واللاعب يفك العبارة ثم يكتب معناها
     بالعربي عشان يوصل لنوع مكان احتجاز نور.
     ============================================================ */
  cipherPuzzle: {
    enabled: true,
    tabLabel: 'فك الشفرة',
    introText: 'كل رقم بيمثل ترتيب حرف في الأبجدية الإنجليزية: A=1، B=2، C=3... لحد Z=26. فك كل مجموعة بالترتيب، وبعدها اكتب معنى العبارة بالعربي.',
    cipherText: '13-1-11-8-26-1-14 / 22-9-12-12-1',
    cipherKey: 'A=1 ... Z=26',
    solutionText: 'مخزن فيلا',
    resultText: 'فكيت الشفرة! MAKHZAN VILLA معناها "مخزن فيلا" — لسه لازم تربط المكان بشهادة سعاد قبل التحرك.',
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنها معلمة خصوصية وده يكفي كدافع، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأن كريم كان في خلاف تجاري مع منتصر، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كانت عايزة تختبر ذكاء منتصر بس من غير أي دافع مالي، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'الشفرة كانت غلطة مطبعية بسيطة مقصودة، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
    ],
