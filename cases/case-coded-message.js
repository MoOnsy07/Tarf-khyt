...
const CASE_CODED_MESSAGE = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — RESCUE', title:'الشفرة اللي فضحت صاحبتها',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: شهادة سعاد، أسئلتها المتكررة، وديونها المالية، قبل ما تتهم.'
    },
    bad: {
