...
const CASE_FINAL_SCENE = {
  ...
  suspects: [
    {
      ...
      confrontations:{
        ...
        writer_credit_dispute:'مراجعة سامي للمعدات كانت شغله العادي، ده مالوش علاقة بيا.',
        safety_fraud_threat:'لو سامي شك في حاجة، كان المفروض يتكلم معايا الأول، مش يهدد بالتبليغ على طول.',
      }
    },
    {
      ...
      loseMsg:'ياسر فعلًا اعترف بغياب قصير عن نقطة التحكم، لكن كاميرا المخزن بتوضح بوضوح إن كريم هو اللي دخل منطقة المعدات في نفس نافذة الغياب دي، مش ياسر. غياب ياسر كان الفرصة اللي استغلها حد تاني، مش دليل على تورطه شخصيًا. اتهامه هيكون مبني على شك ظاهري بس من غير ربط مباشر بلحظة التلاعب الفعلية.',
      questions:[
    ...
    },
    {
      ...
      questions:[
        ...
        { q:'سامي كان بيراجع معدات الأمان بنفسه قبل وفاته ليه؟', unlockId:'writer_credit_dispute',
          a:'"سامي كان دقيق زيادة عن اللزوم في مراجعة المعدات، ده جزء من شغله العادي، مفيش حاجة غريبة في كده."' },
        { q:'سامي كان بيقول لحد إنه لقى حاجة غلط في المعدات؟', requires:['writer_credit_dispute'], unlockId:'safety_fraud_threat',
          a:'(بتتردد) "قال لي قبل موته بأيام إنه شاكك في نوعية معدات الأمان اللي بنستخدمها، وإنه هيراجع الفواتير الرسمية بتاعتها قبل ما يبلّغ رسميًا لو لقى حاجة."' },
      ],
      confrontations:{
  ...
  evidence: [
    ...
    { id:'missing_backup_witness', tag:'من استجواب مريم', crit:false, title:'شاهدة على نقل المعدات الاحتياطية', img: IMG_BASE_FINALSCENE + 'evidence-storage.jpg',
      short:'مريم شافت حد بياخد صندوق المعدات الاحتياطية بدري الصبح',
      full:'مريم شهدت إنها شافت شخص بياخد صندوق معدات الأمان الاحتياطية من المخزن الساعات الأولى من الصبح، قبل ما أي حد يوصل الاستوديو رسميًا. شهادتها وحدها ماتحددش هوية الشخص، لازم دليل تاني يربطه باسم.',
      unlocked:false, order:5 },

    { id:'kareem_entry_card_log', tag:'من سجل دخول المخزن الإلكتروني', crit:true, title:'بطاقة دخول مسجلة باسم كريم للمخزن', img: IMG_BASE_FINALSCENE + 'evidence-entrycard.jpg',
      short:'سجل النظام يوضح اسم "كريم" مسجّل صاحب البطاقة اللي دخلت في نفس توقيت شهادة مريم',
      full:'سجل الدخول الإلكتروني لمخزن المعدات بيوضح دخول بطاقة مسجّلة باسم "كريم" في خانة صاحب البطاقة، في نفس التوقيت اللي وصفته مريم بالظبط — ده اللي بيحوّل شهادتها من "شخص غامض" لهوية محددة بالاسم مسجلة رسميًا في النظام.',
      unlocked:false, order:6 },

    { id:'writer_credit_dispute', tag:'من استجواب هالة', crit:false, title:'سامي كان بيراجع معدات الأمان بنفسه', img:null,
      short:'سامي كان بيراجع فواتير معدات الأمان بدقة غير معتادة قبل وفاته',
      full:'هالة أكدت إن سامي كان بيراجع معدات الأمان ودقتها بشكل غير معتاد في الأيام اللي سبقت وفاته، أكتر من مجرد فحص روتيني عادي.',
      unlocked:false, order:6 },

    { id:'safety_fraud_threat', tag:'من استجواب هالة', crit:true, title:'شك سامي في نوعية معدات الأمان', img:null,
      short:'سامي شك في نوعية معدات الأمان ونوى يراجع فواتيرها الرسمية قبل التبليغ',
      full:'هالة كشفت إن سامي أخبرها قبل وفاته بأيام إنه شاكك في نوعية معدات الأمان المستخدمة في الاستوديو، ونوى يراجع الفواتير الرسمية بتاعتها ويبلّغ رسميًا لو لقى أي تلاعب — وده تهديد مباشر لأي حد كان بيستفيد من فرق تكلفة المعدات.',
    ...
    { id:'counterfeit_equipment_invoice', tag:'من فواتير الموردين', crit:true, title:'فواتير معدات أمان مقلّدة باسم كريم', img: IMG_BASE_FINALSCENE + 'evidence-invoice.jpg',
      short:'كريم كان بيشتري معدات أمان مقلّدة أرخص ويقبض فرق السعر الرسمي',
      full:'مراجعة فواتير الموردين كشفت إن كريم، بصفته منسق المشاهد الخطرة المسؤول عن شراء المعدات، كان بيشتري معدات أمان مقلّدة أرخص من الأصلية، ويقدم فواتير مزوّرة بالسعر الرسمي الكامل للإنتاج، ويقبض الفرق لنفسه لسنين. لو سامي بلّغ عن الشك ده، كان هيفضح احتيال مالي طويل المدى، مش مجرد خطأ بسيط، وهيسبب مسؤولية جنائية مباشرة عن تعريض حياة فريق العمل للخطر.',
  ...
  contradictionPuzzle: {
    enabled: true,
    tabLabel: 'تناقضات',
    introText: 'قارن تصريح ياسر الأول عن وجوده الكامل على نقطة التحكم بشهادته اللاحقة عن الغياب. فيه تصريحين من نفس الشخص مش متوافقين.',
    resultText: 'التناقض واضح: ياسر قال في البداية إنه "كان في مكانه الطبيعي" طول الوقت، لكنه اعترف لاحقًا بغياب قصير — وده يفتح احتمال إن حد استغل نفس اللحظة دي، مش إنه هو الفاعل بالضرورة.',
    resultEvidenceIds: ['rig_log_gap'],
    statements: [
      { id:'st1', text:'"أيوه، كنت في مكاني الطبيعي. الحبل قطع لوحده، أنا ملمستش فيه حاجة غريبة."', source:'ياسر — أول الاستجواب' },
      { id:'st2', text:'"فيه فترة قصيرة سبت فيها المكان أجيب مية."', source:'ياسر — لاحقًا في نفس الاستجواب' },
      { id:'st3', text:'"سامي كان دقيق جدًا في شغله، مستحيل ينزل من غير ما يفحص الحبل بنفسه."', source:'هالة — في الاستجواب' },
      { id:'st4', text:'"شفت حد بياخد صندوق المعدات الاحتياطية من مخزن الاستوديو بدري الصبح."', source:'مريم — في الاستجواب' },
    ],
    correctPair: ['st1','st2'],
  },
  ...
  investigationActions: [
    {
      ...
      requires:['missing_backup_witness'], resultEvidenceIds:['kareem_entry_card_log'],
      successText:'سجل الدخول الإلكتروني يؤكد استخدام بطاقة كريم الشخصية في نفس توقيت شهادة مريم.'
    },
    {
      id:'audit_equipment_invoices', kind:'مراجعة مالية', label:'راجع فواتير موردي معدات الأمان',
      description:'بما إن سامي كان شاكك في نوعية المعدات، راجع فواتير الشراء الرسمية وقارنها بسعر المعدات الأصلية في السوق.',
      requires:['safety_fraud_threat','backup_missing'], resultEvidenceIds:['counterfeit_equipment_invoice'],
      successText:'المراجعة كشفت فرق كبير بين سعر الفواتير الرسمية وسعر المعدات المقلّدة الفعلية المستخدمة، على مدى شهور طويلة.'
    },
  ],

  correctSuspectId: 'kareem_stunt',
  conclusiveEvidenceIds: ['rig_tamper_window', 'camera_timestamp_verified', 'kareem_entry_card_log', 'counterfeit_equipment_invoice'],
    ...
    questions: [
      {
        ...
        options: [
          { id:'a', text:'الكاميرا حددت دخوله منطقة التحكم في نافذة التلاعب بالظبط + فواتير معدات الأمان المقلّدة اللي كان بيربح من فرقها + بطاقة دخوله المسجلة في سجل المخزن الإلكتروني' },
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        'كريم كان بيشتري معدات أمان مقلّدة أرخص من الأصلية لسنين، ويقدم فواتير مزوّرة بالسعر الكامل، ويقبض الفرق لنفسه. لما حس إن سامي شاكك وناوي يراجع الفواتير الرسمية ويبلّغ، استغل لحظة غياب ياسر القصيرة عشان يتلاعب بمعدات التحكم في الحبل قبل ما الاحتيال ينكشف.',
        'اللي قفل الدائرة كان تطابق توقيت الكاميرا مع سجل التلاعب الرقمي، وفواتير المعدات المقلّدة اللي كشفت الاحتيال المالي طويل المدى، وبطاقة دخوله الشخصية المسجلة في سجل المخزن الإلكتروني.',
      ]
    },
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: نافذة التلاعب الرقمية، تأكيد الكاميرا، بطاقة الدخول، وفواتير المعدات المقلّدة، قبل ما تتهم.'
    },
    bad: {
