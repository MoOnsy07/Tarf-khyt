...
const CASE_FINAL_SCENE = {
  ...
  evidence: [
    ...
    { id:'kareem_entry_card_log', tag:'من سجل دخول المخزن الإلكتروني', crit:true, title:'بطاقة دخول كريم للمخزن', img: IMG_BASE_FINALSCENE + 'evidence-entrycard.jpg',
      short:'سجل الدخول الإلكتروني يوثق استخدام بطاقة كريم الشخصية في نفس توقيت شهادة مريم',
      full:'سجل الدخول الإلكتروني لمخزن المعدات بيوضح استخدام بطاقة دخول كريم الشخصية في نفس التوقيت اللي وصفته مريم بالظبط — ده اللي بيحوّل شهادتها من "شخص غامض" لهوية محددة بالاسم.',
  ...
  conclusiveEvidenceIds: ['rig_tamper_window', 'camera_timestamp_verified', 'kareem_entry_card_log', 'writer_credit_dispute'],
    ...
    questions: [
      {
        ...
        options: [
          { id:'a', text:'الكاميرا حددت دخوله منطقة التحكم في نافذة التلاعب بالظبط + خلافه على حقوق فكرة المشهد + بطاقة دخوله المسجلة في سجل المخزن الإلكتروني' },
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        ...
        'اللي قفل الدائرة كان تطابق توقيت الكاميرا مع سجل التلاعب الرقمي، وبطاقة دخوله الشخصية المسجلة في سجل المخزن الإلكتروني بعد شهادة مريم، وخلاف حقوق الفكرة اللي وفّر الدافع الحقيقي بعيدًا عن أي عداوة ظاهرة.',
      ]
    },
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: نافذة التلاعب الرقمية، تأكيد الكاميرا، بطاقة الدخول، وخلاف حقوق الفكرة، قبل ما تتهم.'
    },
    bad: {
