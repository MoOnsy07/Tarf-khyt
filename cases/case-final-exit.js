...
const CASE_FINAL_EXIT = {
  ...
  theoryBuilder: {
    ...
    questions:[
      ...
      { id:'exit_reason', label:'ليه اتعمل الخروج الوهمي؟', options:[ {id:'a',text:'عشان يغطي على قتل كريم اللي كان مخطط له مسبقًا مع حسام في الممر'}, {id:'b',text:'لإغلاق حالة كريم وتجنب مراجعة مخالفات الوردية بعد ما بطاقته توقفت عن العمل ليلًا'}, {id:'c',text:'عشان يغطي على تقصيره في متابعة كاميرات المصعد والبوابات الليلة دي، وده هيفضحه قدام الإدارة'}, {id:'d',text:'عشان يستر على عطل حقيقي في نظام المصعد اكتشفه مروان بعد الحادثة ومطلعوش رسميًا'} ], correctOptionId:'b' },
      { id:'archive_truth', label:'إزاي وصل كريم للأرشيف؟', options:[ {id:'a',text:'اتنقل كجثة على عربة الملفات بعد ما مات في الممر على إيد حسام مباشرة'}, {id:'b',text:'نزل بنفسه وطلب فتحًا أمنيًا بعد ما بطاقته لم تعمل ليلًا، ودخل الأرشيف وهو لسه قادر يتحرك بمفرده'}, {id:'c',text:'حسام حمله بنفسه للأرشيف بعد الشجار عشان يخفي اللي حصل ويرجعه مكانه'}, {id:'d',text:'مروان نقله بالمصعد لطابق الخدمات باستخدام مفتاح الصيانة اللي كان في عهدته'} ], correctOptionId:'b' },
      { id:'document_truth', label:'إيه حقيقة ملف المشروع؟', options:[ {id:'a',text:'سرقة مالية مباشرة قامت بيها سارة لوحدها من حساب المشروع، وده اللي اكتشفه كريم واستخدمه ضدها'}, {id:'b',text:'مسار الخدمات والتصاريح استُخدموا قديمًا لنقل واستبدال مستندات أصلية خارج التوثيق المعتاد، وده اللي كان كريم بيدور عليه'}, {id:'c',text:'شركة الصيانة اللي بتشتغل على مسار الخدمة كلها وهمية بالكامل ومالهاش وجود رسمي في عقود البرج'}, {id:'d',text:'الصفحة الثامنة من الملف لم توجد أصلًا، وليلى اخترعت وجودها عشان تبرر تأخيرها في الرد على كريم'} ], correctOptionId:'b' }
    ]
  },
