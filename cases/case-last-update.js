...
const CASE_LAST_UPDATE = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه مؤسس الشركة وده يكفي كدافع، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأن كريم كان بينافسه على ترقية، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان مخطط للقتل من البداية عشان يحمي جولة التمويل، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'كان بيحاول يصلح الثغرة بنفسه بس، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'كود واحد كشف الجريمة',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: سجل الدخول، محاولة الإسكات، وكلام يوسف الأخير، قبل ما تتهم.'
    },
    bad: {
