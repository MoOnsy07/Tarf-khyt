...
const CASE_NUMBER_19 = {
  ...
  suspects: [
    ...
    },
    {
      ...
      questions:[
        { q:'إنت وعمر بينكم منافسة على نفس المركز، صح؟', unlockId:'rivalry_admission',
    ...
    },
    {
      ...
      questions:[
        { q:'سجلات القطاع كلها موثقة صح؟', unlockId:'age_records_hint',
  ...
  endings: {
    good: {
      stamp:'SAFE', badgeLabel:'CASE CLOSED — HE IS SAFE', title:'عمر بخير، والحقيقة اتكشفت',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: شكوى عمر، فيديو التدريب المقصوص، وتحرك GPS، قبل ما تقدّم استنتاجك النهائي.'
    },
    bad: {
