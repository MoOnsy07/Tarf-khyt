...
const CASE_BLUEPRINT_LEAK = {
  ...
  codeLockPuzzle: {
    ...
    introText: 'يوسف عنده لابتوب احتياطي بسيط الحماية بيستخدمه للنسخ الاحتياطي بس، مقفول بكود 4 أرقام. من مراجعة ملفات الشركة: الشركة اتأسست في الشهر التالت من السنة، ورقم براءة الاختراع الرسمية المسجلة باسم الشركة بينتهي بـ 47. يوسف معروف بين زمايله إنه بيستخدم أرقام ليها معنى مرتبط بإنجازاته المهنية كباسورد لأي حاجة بسيطة الحماية.',
    code: '0347',
    hint: 'دور في أرقام مرتبطة بإنجاز مهني فخور بيه يوسف — مش تاريخ ميلاد أو رقم عشوائي',
    wrongMsg: '✗ الرقم غلط، فكر في أرقام تانية مرتبطة بالشركة.',
