...
const CASE_BLUEPRINT_LEAK = {
  ...
  evidence: [
    ...
    { id:'technical_flaw_report', tag:'من استجواب منى', crit:true, title:'تقرير عيب أمان خطير', img: IMG_BASE_BLUEPRINTLEAK + 'evidence-report.jpg',
      ...
      full:'منى كشفت إن فريق الجودة رفع تقرير رسمي قبل الإطلاق بأسبوع بيحذر من عيب أمان جوهري في المنتج، لكن التقرير تم تجاهله رسميًا من الإدارة العليا.',
    ...
    { id:'insurance_claim_filed', tag:'من سجلات التأمين', crit:true, title:'مطالبة تأمينية مشبوهة', img: IMG_BASE_BLUEPRINTLEAK + 'evidence-insurance.jpg',
      ...
      full:'سجلات شركة التأمين بتوضح إن بوليصة الشركة بتغطي تحديدًا حالات "سرقة الملكية الفكرية" بمبلغ تعويض كبير، وإن يوسف رفع مطالبة رسمية بموجبها في نفس يوم التسريب بالظبط، قبل ما التحقيق الرسمي حتى يبدأ — وده يحوّل الموقف من "ضحية تسريب" لمحاولة احتيال على شركة التأمين نفسها.',
      unlocked:false, order:7 },

    { id:'intermediary_contact_found', tag:'من فك تشفير اللابتوب', crit:true, title:'تواصل مع وسيط مجهول', img: IMG_BASE_BLUEPRINTLEAK + 'evidence-laptop.jpg',
      short:'رسائل مع شخص مجهول يتكلم عن "تسريب المخطط من غير ما يتربط بيوسف"',
      full:'تحليل لابتوب يوسف الاحتياطي كشف محادثات مع شخص مجهول (متعارف عليه بس باسم مستعار "M")، بيتكلموا فيها عن "طريقة يتسرب بيها المخطط من غير ما يترجع لمصدر داخلي". المحادثات وحدها ما تثبتش إن يوسف هو اللي دفع فعليًا لحد ينشر الملف — لسه محتاج تتبع الدفع.',
      unlocked:false, order:8 },

    { id:'leak_source_traced', tag:'من تتبع الدفع', crit:true, title:'الدفع للوسيط اللي رفع الملف', img: IMG_BASE_BLUEPRINTLEAK + 'evidence-payment.jpg',
      short:'تحويل مالي من يوسف لنفس الحساب اللي رفع الملف على المنتدى',
      full:'تتبع المحفظة الرقمية المرتبطة بالحساب المجهول "M" كشف تحويل مالي صادر من حساب يوسف الشخصي، في نفس اليوم اللي اتنشر فيه المخطط على المنتدى. ده اللي بيربط يوسف مباشرة بعملية التسريب، مش بس بمعرفة مسبقة بالعيب الأمني.',
  ...
  codeLockPuzzle: {
    enabled: true,
    tabLabel: 'فك تشفير لابتوب النسخ الاحتياطي',
    introText: 'يوسف عنده لابتوب احتياطي بسيط الحماية بيستخدمه للنسخ الاحتياطي بس، مقفول بكود 4 أرقام. من مراجعة ملفات الشركة: الشركة اتأسست في الشهر التالت من السنة، ورقم براءة الاختراع الرسمية المسجلة باسم الشركة بينتهي بـ 47. يوسف معروف بين زمايله إنه بيستخدم أرقام ليها معنى مرتبط بإنجازاته المهنية كباسورد لأي حاجة بسيطة الحماية — مفيش ورقة أو تلميح مكتوب يشرحلك إزاي تركّب الرقم، لازم تجرب بنفسك.',
    code: '0347',
    hint: 'جرب تركيبات مختلفة من الرقمين اللي عرفتهم — مش بالضرورة بنفس الترتيب اللي فكرت فيه أول مرة',
    wrongMsg: '✗ الرقم غلط، جرب ترتيب تاني للرقمين.',
    resultText: 'اتفتح اللابتوب. لقيت رسائل بتوضح إن يوسف كان عارف بعيب الأمان الخطير من زمان، ومعاها محادثات مع شخص مجهول باسم مستعار "M" عن طريقة تسريب المخطط من غير ما يترجع لمصدر داخلي. المحادثات وحدها لسه مش كافية — محتاج تتبع أي تحويل مالي فعلي بينه وبين الحساب ده.',
    resultEvidenceIds: ['intermediary_contact_found'],
  },
  ...
  investigationActions: [
    {
      ...
      successText:'المراجعة أكدت إن المطالبة التأمينية اتقدمت في نفس ساعات التسريب تقريبًا، قبل أي تحقيق رسمي، وإنها بتغطي تحديدًا حالات سرقة الملكية الفكرية بمبلغ تعويض كبير.'
    },
    {
      id:'trace_intermediary_payment', kind:'تتبع مالي رقمي', label:'تتبع أي تحويل مالي لحساب الوسيط المجهول',
      description:'المحادثات مع "M" وحدها مش دليل قاطع — تتبع أي تحويل رقمي من حسابات يوسف الشخصية لنفس المحفظة.',
      requires:['intermediary_contact_found','insurance_claim_filed'], resultEvidenceIds:['leak_source_traced'],
      successText:'تتبع المحفظة الرقمية كشف تحويل صادر من حساب يوسف الشخصي لنفس الحساب المجهول، في يوم التسريب بالظبط.'
    },
  ],
    ...
    questions: [
      {
        ...
        options: [
          { id:'a', text:'تتبع الدفع أثبت تحويل من حسابه الشخصي لحساب الوسيط المجهول + تجاهله المتعمد لتقرير العيب الأمني الخطير + مطالبته التأمينية المشبوهة في نفس يوم التسريب' },
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        'يوسف كان عارف من تقرير طارق إن المنتج فيه عيب أمان خطير هيسبب كارثة وفضيحة بعد الإطلاق. بدل ما يواجه خسارة مؤكدة وانهيار سمعة الشركة، دفع لوسيط مجهول ("M") ينشر المخطط من غير ما يترجع له، ورفع مطالبة تأمينية ضخمة بدعوى "سرقة ملكية فكرية" في نفس اليوم.',
        'اللي قفل الدائرة كان تتبع التحويل المالي من حسابه الشخصي لحساب الوسيط، ومحادثاته معاه في اللابتوب الاحتياطي، وتجاهله الموثق لتحذير طارق، وتوقيت المطالبة التأمينية المريب اللي سبق أي تحقيق رسمي.',
      ]
    },
    partial: {
