...
const CASE_RECORDED_VOICE = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — RESCUE', title:'الصوت المشوّه ما قدرش يخبي نفسه',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: التحليل الصوتي، دافعه المهني، وتسريب موضوع الحلقة، قبل ما تتهم.'
    },
    bad: {
