...
const CASE_ARCHIVE_FIRE = {
    ...
    },
    {
      ...
      questions:[
        ...
        { q:'لاحظت أي حد غريب حوالين القبو قبل الحريق؟', unlockId:'farouk_saw_someone', requires:['farouk_long_tenure'],
          a:'"شفت طرحة كحلي مميزة بتاعة نبيلة بتدخل من باب القبو الجانبي قبل الحريق بساعة تقريبًا، ناديت عليها بالاسم من غير تفكير، بس ماردتش وكملت جوه بسرعة."' },
  ...
  evidence: [
    ...
    { id:'farouk_saw_someone', tag:'من استجواب فاروق', crit:true, title:'فاروق يتعرف على نبيلة عند باب القبو', img: IMG_BASE_ARCHIVEFIRE + 'evidence-doorway.jpg',
      short:'فاروق تعرّف على طرحة نبيلة المميزة عند باب القبو الجانبي قبل الحريق بساعة',
      full:'فاروق شهد إنه شاف طرحة نبيلة الكحلي المميزة بتدخل من باب القبو الجانبي قبل اندلاع الحريق بساعة تقريبًا، وناداها بالاسم من عادته، لكنها ماردتش وكملت جوه بسرعة.',
    ...
    { id:'accelerant_purchase_record', tag:'من سجل محل مواد بناء', crit:true, title:'إيصال شراء مادة قابلة للاشتعال', img: IMG_BASE_ARCHIVEFIRE + 'evidence-receipt.jpg',
      short:'إيصال شراء مادة قابلة للاشتعال مدفوع ببطاقة نبيلة قبل الحريق بيومين',
      full:'محل مواد بناء قريب من المبنى عنده إيصال شراء لكمية من مادة قابلة للاشتعال، اتدفعت ببطاقة بنكية مسجلة باسم نبيلة، قبل الحريق بيومين بالظبط.',
  ...
  correctSuspectId: 'nabila_descendant',
  conclusiveEvidenceIds: ['nabila_phone_location', 'accelerant_purchase_record', 'farouk_saw_someone', 'grandfather_secret'],
    ...
    questions: [
      {
        ...
        options: [
          { id:'a', text:'سجل أبراج الاتصال وضع هاتفها قريب من المبنى وقت الحريق رغم أليبيها المُعلن + إيصال شراء المادة القابلة للاشتعال ببطاقتها + تعرّف فاروق عليها بالتحديد عند باب القبو' },
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        ...
        'اللي قفل الدائرة كان سجل أبراج الاتصال اللي كسر أليبيها المُعلن ووضع هاتفها قريب من المبنى وقت الحريق، وإيصال شراء المادة القابلة للاشتعال المدفوع ببطاقتها، وتعرّف فاروق عليها بالتحديد عند باب القبو.',
      ]
    },
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: موقع الهاتف، إيصال شراء المادة القابلة للاشتعال، وتعرّف فاروق عليها، قبل ما تتهم.'
    },
    bad: {
