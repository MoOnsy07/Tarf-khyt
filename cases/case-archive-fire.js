...
const CASE_ARCHIVE_FIRE = {
  ...
  evidence: [
    ...
    { id:'handyman_identifies_nabila', tag:'من شهادة العامل', crit:true, title:'العامل يتعرف على نبيلة كصاحبة الطلب', img: IMG_BASE_ARCHIVEFIRE + 'evidence-handyman.jpg',
    ...
    { id:'nabila_cash_withdrawal', tag:'من سجلات البنك', crit:true, title:'سحب نقدي مطابق قبل الشراء', img: IMG_BASE_ARCHIVEFIRE + 'evidence-bankslip.jpg',
