...
const CASE_ARCHIVE_FIRE = {
  ...
  evidence: [
    ...
    { id:'missing_employee_record', tag:'من سجلات الملكية', crit:false, title:'ملف الموظف المفقود من السبعينات', img:null,
      short:'سجلات قديمة تؤكد وجود ملف موظف اختفى في نفس فترة السبعينات',
      full:'سجلات ملكية المبنى القديمة أكدت وجود ملف رسمي لموظف اختفى فجأة في فترة السبعينات، بنفس التوقيت اللي ذكرته نبيلة عن سر جدها، وده يثبت إن الحادثة القديمة دي حقيقية مش مجرد كلام عائلي.',
    ...
    { id:'accelerant_purchase_record', tag:'من سجل محل مواد بناء', crit:false, title:'إيصال شراء مادة قابلة للاشتعال', img: IMG_BASE_ARCHIVEFIRE + 'evidence-receipt.jpg',
      short:'إيصال شراء مادة قابلة للاشتعال مدفوع ببطاقة نبيلة قبل الحريق بيومين',
      full:'محل مواد بناء قريب من المبنى عنده إيصال شراء لكمية من مادة قابلة للاشتعال، اتدفعت ببطاقة بنكية مسجلة باسم نبيلة، قبل الحريق بيومين بالظبط. الإيصال وحده ما يثبتش إنها نفس المادة اللي استخدمت في الحريق فعليًا.',
      unlocked:false, order:12 },

    { id:'store_camera_photo', tag:'من كاميرا المحل', crit:true, title:'صورة كاميرا المحل وقت الشراء', img: IMG_BASE_ARCHIVEFIRE + 'evidence-storecam.jpg',
      short:'كاميرا المحل صورت وش نبيلة بوضوح وقت شراء المادة',
      full:'كاميرا مراقبة المحل صورت وش الشخص اللي اشترى المادة بوضوح، ووش الصورة يطابق نبيلة تمامًا — ده اللي بيكمّل هوية الشخص اللي وصفه فاروق جزئيًا.',
  ...
  investigationActions: [
    ...
    },
    {
      ...
      successText:'محل قريب من المبنى أكد بيع مادة قابلة للاشتعال بإيصال مدفوع ببطاقة نبيلة قبل الحريق بيومين.'
    },
    {
      id:'pull_store_camera_footage', kind:'مراجعة كاميرات', label:'اطلب تسجيل كاميرا المحل وقت عملية الشراء',
      description:'وصف فاروق جزئي بس — اطلب كاميرا المحل عشان تكمّل الهوية بصورة واضحة للوش.',
      requires:['accelerant_purchase_record'], resultEvidenceIds:['store_camera_photo'],
      successText:'كاميرا المحل صورت وش المشتري بوضوح، ويطابق نبيلة تمامًا.'
    },
    {
      ...
      requires:['store_camera_photo'], resultEvidenceIds:['accelerant_lab_match'],
      successText:'المعمل أكد تطابق بقايا الحريق مع نفس نوع المادة المذكورة في إيصال الشراء بالضبط.'
    },
  ],

  correctSuspectId: 'nabila_descendant',
  conclusiveEvidenceIds: ['store_camera_photo', 'accelerant_lab_match', 'nabila_phone_location', 'grandfather_secret'],
    ...
    questions: [
      {
        ...
        options: [
          { id:'a', text:'كاميرا المحل صورت وشها بوضوح وقت شراء المادة + التحليل المعملي طابق بقايا الحريق بنفس المادة + سجل أبراج الاتصال وضع هاتفها قريب من المبنى رغم أليبيها المُعلن' },
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        'نبيلة مش لها علاقة بمعركة الهدم الحديثة خالص. الحريق كان محاولة لتدمير أرشيف قديم يخص حادثة اختفاء موظف في السبعينات، كان جدها متورط في التغطية عليها. لما حست إن التصويت الجديد ممكن يفتح المبنى لمراجعة كاملة تكشف الأرشيف القديم، اشترت مادة قابلة للاشتعال ودخلت من الممر الجانبي اللي ماكنش يعرفه غير عيلتها، وأشعلت الحريق قبل ما حد يوصل للحقيقة.',
        'اللي قفل الدائرة كان تعرّف كاميرا المحل على وشها وقت الشراء، والتحليل المعملي اللي طابق بقايا الحريق بنفس نوع المادة، وسجل أبراج الاتصال اللي كسر أليبيها المُعلن ووضع هاتفها قريب من المبنى وقت الحريق.',
      ]
    },
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: صورة كاميرا المحل، المطابقة المعملية، وموقع الهاتف، قبل ما تتهم.'
    },
    bad: {
