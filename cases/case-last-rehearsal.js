...
const CASE_LAST_REHEARSAL = {
  ...
  suspects: [
    {
      ...
      confrontations:{
        role_rivalry:'كنت مرشحة للدور فعلاً، بس المخرج اختار عادل وأنا قبلت القرار.'
      }
    },
    {
      ...
      confrontations:{
        role_rivalry:'ناردين كانت مرشحة قوية، بس عادل كان الأنسب للدور في رأيي.',
        director_hint:'خالد وعادل كانوا بيتدربوا مع بعض كتير، ده طبيعي بينهم كدوبلير.'
      }
    },
    {
      ...
      confrontations:{
        director_hint:'أنا وعادل كنا قريبين فعلاً، بنتدرب مع بعض على نفس الدور.',
        props_access:'أنا بحط الأدوات على الطاولة زي كل يوم، ده شغلي بالظبط.',
        throat_spray_analysis:'معرفش إزاي المادة دي وصلت للبخاخ، أنا ماحطتش حاجة فيه.',
        makeup_kit_match:'البقايا دي ممكن تكون من حاجة تانية، مش من البخاخ اللي حصل بيه المكروه.'
      }
    },
    {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه دوبلير عادل وده بيديه دافع تلقائي، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأنه اتلعثم أثناء الاستجواب، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'المسدس فعلًا اتبدّل برصاصة حقيقية، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'عادل مات من نوبة قلبية طبيعية، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'التمويه اتكشف',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل 4 أدلة من: مسؤوليته عن التجهيز، تحليل البخاخ، وتطابق أدوات المكياج، قبل ما تتهم.'
    },
    bad: {
