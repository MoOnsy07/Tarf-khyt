...
const CASE_VANISHED_WIFE = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأن شريف بلّغ الشرطة متأخر شوية، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأن عم صابر شافها نازلة بسرعة، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'منى اتخطفت من حد غريب، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'منى نسيت موبايلها وتاهت بالصدفة، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'بأمان', badgeLabel:'القضية اتقفلت — هي بأمان', title:'منى بخير، والحقيقة اتكشفت',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل 4 أدلة من: تبرير شريف للمراقبة، تغيّر تصرفات منى، وطلبها مساعدة يارا، قبل ما تقدّم استنتاجك النهائي.'
    },
    bad: {
