...
const CASE_SECRET_CLINIC = {
  ...
  suspects: [
    ...
    },
    {
      ...
      questions:[
        ...
        { q:'إنتِ قلتي لدنيا إن إيمان سافرت فجأة، لكن سجل المستشفى بيقول إنها دخلت طوارئ باسم مستعار. ليه بعتّي الرسالة دي؟', requires:['donia_suspicious_message','hospital_admission_record'],
  ...
  evidence: [
    ...
    { id:'donia_suspicious_message', tag:'من رسائل دنيا', crit:true, title:'رسالة مريبة من غادة', img: IMG_BASE_SECRETCLINIC + 'clinic-message.jpg',
      ...
      full:'دنيا كشفت عن رسالة من غادة بتدّعي إن إيمان قررت تسافر فجأة، رغم عدم منطقية الأمر نظرًا لحالتها بعد العملية مباشرة. الرسالة بقت خيط محتاج تفسير بعد مراجعة السجلات الطبية.',
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه أجرى العملية وده يكفي، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأن غادة كانت آخر واحدة شافتها، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'إيمان سافرت فعلاً بإرادتها زي ما قالت غادة، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'عاطف صاحب الشقة هو اللي كان وراء اختفائها، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        ...
        'أما رسالة غادة عن سفر إيمان، فكانت قصة تغطية طلب منها صبري تبعتها عشان يمنع أهل إيمان من الوصول للمستشفى وربط الحالة بالعيادة غير المرخصة. غادة اعترفت إنها وافقت على الكذبة بعد ما واجهتها بسجل الدخول باسم مستعار.',
      ]
    },
    partial: {
