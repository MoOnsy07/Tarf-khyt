...
const CASE_ONE_COMMENT = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه بعت رسالة غاضبة وده يكفي، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأن يحيى كان صاحب السر الأصلي، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان مخطط للقتل من البداية بدافع الانتقام، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'كان بيحاول يحمي يحيى فقط، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'تعليق واحد كفى لتفجير الحقيقة',
      paragraphs:[
