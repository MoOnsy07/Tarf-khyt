...
const CASE_OPENING_NIGHT = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه مدير أعماله وده يكفي، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'لأن جهاد كان المنافس الأوضح، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان ناوي يقتله من البداية عشان الغيرة المهنية، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'كان بيحاول يساعده يستعد للعرض بمكمل غذائي، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'العرض اللي ما خلصش',
      paragraphs:[
