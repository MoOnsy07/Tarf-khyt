...
const CASE_VAR_CONSPIRACY = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الفساد كان في التفاصيل مش في النتيجة',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: تفسير الفجوة، كاميرا الممر، وبيانات الرهانات، قبل ما تتهم.'
    },
    bad: {
