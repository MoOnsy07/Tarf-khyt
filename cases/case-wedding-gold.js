...
const CASE_WEDDING_GOLD = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الدهب رجع للعروسة',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: الديون، الشهادة القريبة، وشهادة رضا، قبل ما تتهم.'
    },
    bad: {
