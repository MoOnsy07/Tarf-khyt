...
const CASE_WEDDING_GOLD = {
  ...
  evidence: [
    ...
    { id:'gold_bag_found', tag:'من تفتيش القاعة', crit:true, title:'العثور على الشنطة والدهب في نقطة إخفاء على المسار', img: IMG_BASE_GOLD + 'gold-bag.jpg',
      short:'الشنطة والدهب اتلاقوا مخبّيين في صندوق خدمة على نفس مسار الحركة وقت الضلمة',
      full:'بعد إعادة بناء مسار الحركة وقت انقطاع الكهربا من الفيديو وشهادة رضا، التفتيش ركز على الممر الجانبي وصندوق خدمة على نفس المسار القريب من مكان إبراهيم. الشنطة الفاضية والدهب اتلاقوا مخبّيين جوه الصندوق — مكان العثور وحده لا يحدد مين وضعهم هناك.',
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه ابن عم العريس بس، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأنه كان متضايق في الفرح، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
      {
...
(() => {
  ...
  c.investigationActions=[...(c.investigationActions||[]).filter(a=>a.id!=='wedding_search_route_v2' && a.id!=='wedding_search_route_v3'),{
    ...
    successText:'تم العثور على الشنطة والدهب مخبّيين في صندوق الخدمة على نفس المسار. مكان الإخفاء اتثبت، لكن هوية السارق لسه محتاجة ربط باقي القرائن.'
  }];
