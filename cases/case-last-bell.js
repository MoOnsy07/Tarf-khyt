...
const CASE_LAST_BELL = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه مدرّس زميل وده يكفي كدافع، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأن جمال مدير المدرسة كان مستفيد أكتر ماليًا، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان مخطط لقتله من البداية عشان يحمي مصدر دخله، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'كان بيحاول يحمي جمال المدير بس، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'الجرس اللي فضح الشبكة',
      paragraphs:[
...
(() => {
  ...
  c.endings.partial.hint = 'اجمع على الأقل 4 أدلة من: مسار الفلوس، اعتراف وائل بالشبكة، وشهادة عم راتب، قبل ما تتهم.';
