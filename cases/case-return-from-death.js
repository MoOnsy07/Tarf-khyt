  ...
  theoryBuilder: {
    ...
    questions:[
      ...
      },
      {
        ...
        options:[
          {id:'a',text:'قتل رضا بنفسه في شقة كريم عشان يجهزه كجثة بديلة، وده اللي فتح الطريق للخطة كلها'},
          {id:'b',text:'سهّل مسار العينة والتعرّف الأولي المضلل من غير ما يشارك في عملية القتل نفسها ولا يعرف بيها'},
          {id:'c',text:'قتل كريم الحقيقي بنفسه بعد ما الخطة الأولى نجحت وماعادش محتاج يغطي عليه'},
          {id:'d',text:'لا علاقة له بأي شيء، ومجرد اسمه ظهر في السجلات بالصدفة من غير أي تورط فعلي'},
        ], correctOptionId:'b',
      },
      {
      ...
      },
      {
        ...
        options:[
          ...
          {id:'b',text:'غيرة عاطفية من علاقة كريم القديمة بمنى قبل ما يتجوز، وده خلاه يحس إن كريم بياخد كل حاجة منه'},
          {id:'c',text:'خلاف قديم على ملكية الشقة اللي كانت باسم كريم بس مروان كان شريك فيها بالفلوس من الأول'},
          {id:'d',text:'انتقام لرضا بس، بعد ما حس إن كريم استخدمه كجثة بديلة من غير ما ياخد إذنه ولا يعوضه'},
        ], correctOptionId:'a',
      },
    ],
  },
