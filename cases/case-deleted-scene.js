...
const CASE_DELETED_SCENE = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'ريما اتخطفت فعليًا من طاقم الإنتاج، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'ريما اعتزلت بسبب خلاف شخصي مع البطل طارق، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'بأمان', badgeLabel:'القضية اتقفلت — هي بأمان', title:'ريما بخير، والحقيقة اتكشفت',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل 4 أدلة من: حادث التصوير، مصدر أمر حذف المشهد، التحليل الصوتي، وتسجيل ريما، قبل ما تحدد المسؤول عن التغطية.'
    },
    bad: {
