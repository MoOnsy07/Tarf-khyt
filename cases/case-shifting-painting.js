    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه جامع لوحات وده كافي، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'لأنه تردد أثناء الاستجواب، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'اللوحة كلها مزيفة من الأساس، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'اللوحة اتسرقت واستبدلت بنسخة مطابقة تمامًا، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
    ],
