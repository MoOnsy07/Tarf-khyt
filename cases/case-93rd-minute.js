...
const CASE_93RD_MINUTE = {
    ...
    },
    {
      ...
      questions:[
        ...
        { q:'الكاميرا والشاهد حطوك عند ثلاجة الزجايز في نفس التوقيت، وصفقة كريم كانت هتقع لو فضل احتياطي — عايز تفسر؟', requires:['sherif_seen_near','transfer_pressure','sideline_camera_footage'], closesInterrogation:true,
          a:'(بيسكت ووشه بيتغير) "كنت عايز يطلع تحليله إيجابي ويتوقف فترة، وكريم ياخد فرصته. ماكنتش ناوي أقتله... استخدمت كمية أكبر من اللي كنت فاكر إنها هتعمل مجرد نتيجة إيجابية، والموضوع خرج من إيدي."' },
      ]
    },
  ],
  ...
  evidence: [
    ...
    { id:'sherif_seen_near', tag:'من شهادة عابرة', crit:true, title:'شريف قريب من ثلاجة الزجايز', img:null,
  ...
  cameraPuzzle: {
    ...
    introText: 'كاميرا الملعب الجانبية بتغطي من الساعة 6 مساءً (قبل الماتش) لحد 9 بالليل. دوّر على اللحظة اللي شريف بيقرب فيها من ثلاجة الزجايز — قبل الماتش بساعة تقريبًا، حوالي الساعة 7:00.',
    resultText: 'ظبطت اللحظة الصح. الكاميرا بتوضح شريف داخل منطقة المعدات وواقف عند ثلاجة الزجايز حوالي الساعة 7:00، وده متوافق مع شهادة العامل.',
    startHour24: 18,
    totalMinutes: 180,
    targetMinutes: 60,
    toleranceMinutes: 8,
  ...
  evidenceCombinations: [
    { parts:['bottle_prep','transfer_pressure'], resultId:'sherif_seen_near' },
  ],

  correctSuspectId: 'agent_sherif',
  conclusiveEvidenceIds: ['transfer_pressure', 'sherif_seen_near', 'sideline_camera_footage', 'bottle_prep'],
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        'شريف كان تحت ضغط صفقة انتقال كبيرة لموكله كريم، ومكان كريم في الصفقة مرتبط بإنه يلعب أساسي. خطته ماكانتش قتل بيشوي؛ كان عايز يلوّث زجاجته بمادة محظورة عشان تحليله يطلع إيجابي ويتوقف فترة. لكنه استخدم كمية أخطر بكتير من اللي توقعها، وده انتهى بوفاة بيشوي.',
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: دافعه المالي، شهادة العامل، وكاميرا الملعب، قبل ما تتهم.'
    },
    bad: {
