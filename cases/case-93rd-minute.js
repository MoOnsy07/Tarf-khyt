  ...
  suspects: [
    ...
    },
    {
      ...
      questions:[
        ...
        { q:'كنت قريب من غرفة تجهيز المعدات في أي وقت؟', unlockId:'sherif_seen_near', requires:['staff_witness_lead'],
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه وكيل أعمال وده يكفي، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأنه تردد وقت السؤال، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان ناوي يقتله من البداية عشان مصلحة موكله، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'كان بيحاول يحسن أداء بيشوي بالغلط، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
