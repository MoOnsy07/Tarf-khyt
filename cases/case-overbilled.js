...
const CASE_OVERBILLED = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'فاتورة واحدة كشفت كل حاجة',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: اعترافه بالعمولات، شهادة الجار، وشهادة منير، قبل ما تتهم.'
    },
    bad: {
