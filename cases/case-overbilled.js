    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه شريك فتحي وده يكفي كدافع، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأن مدحت المورد كان طرف في الصفقة، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان مخطط للقتل من البداية عشان يستولي على المطعم بالكامل، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'كان بيحاول يوقع مدحت في المشكلة بس، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
