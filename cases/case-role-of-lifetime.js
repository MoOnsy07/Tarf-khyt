    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه صحفي بيغطي كواليس المسلسل، وطبيعي إن أي حد بيسأل أسئلة كتير يبقى مشتبه فيه فورًا' },
          { id:'c', text:'لأنه كان موجود في اللوكيشن وقت الحادثة، وده وحده كفاية عشان تشك فيه من غير أي دليل تاني' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'الدكتور راغب مات فعلًا زي ما هو موثق رسميًا، والصحفي كريم بس شبهه بالصدفة وده اللي لخبط الموضوع' },
          { id:'c', text:'ابنه يحيى هو اللي دبّر كل حاجة عشان يحمي إرث والده ويمنع كشف تفاصيل كان حريص إنها تفضل سرية' },
        ],
        correctOptionId:'a',
      },
    ],
