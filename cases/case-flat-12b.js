...
const CASE_FLAT_12B = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه زميل شغلها وده يكفي، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'لأن الباب كان مخلوع من الداخل بس، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
      {
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إنقاذ', title:'الكاميرا المعطلة كانت الخيط',
      paragraphs:[
...
(() => {
  ...
  c.endings.partial.hint = 'اجمع على الأقل 4 أدلة من: ضغط المخالفات، وصف الحارس، وكسر حجة اجتماع رامي، قبل ما تتهم.';
