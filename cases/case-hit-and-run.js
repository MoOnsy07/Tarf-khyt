...
const CASE_HIT_AND_RUN = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الحقيقة وصلت من الكاميرا',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: شهادة نور، إيصال التاكسي، وتسجيل الكاميرا، قبل ما تتهم.'
    },
    bad: {
