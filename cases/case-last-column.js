...
const CASE_LAST_COLUMN = {
  ...
  contradictionPuzzle: {
    enabled: true,
    tabLabel: 'تناقضات',
    introText: 'قارن إنكار نبيل لأي تواصل مباشر بسجل الاتصالات الفعلي. فيه تصريح واضح مش متوافق مع الدليل.',
    resultText: 'التناقض واضح: نبيل أنكر أي مكالمة مباشرة مع طارق، لكن سجل الاتصالات بيثبت مكالمة من رقمه الشخصي قبل الوفاة بساعة بالظبط.',
    resultEvidenceIds: ['lawyer_contradiction'],
    statements: [
      { id:'st1', text:'"مكلمتوش، ودي أول مرة أسمع عن اتصال زي ده."', source:'نبيل — في الاستجواب' },
  ...
  conclusiveEvidenceIds: ['nabil_call_log', 'decoded_warning', 'lawyer_contradiction'],
    ...
    questions: [
      {
        ...
        options: [
          { id:'a', text:'سجل الاتصالات أثبت مكالمة مباشرة قبل الوفاة رغم إنكاره + الرسالة المشفرة كشفت إن طارق كان بيهدده بالابتزاز + تناقض مسار التهديد القانوني' },
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        'طارق ماكانش بس صحفي بيفضح فساد نبيل — كان بيستغل المعلومات اللي وصلته من عادل عشان يبتز نبيل شخصيًا، طالبًا مبلغ مالي إضافي مقابل تأجيل النشر. لما نبيل حس إن المبلغ هيتكرر طلبه للأبد، قرر يسكته نهائيًا.',
        'اللي قفل الدائرة كان سجل الاتصالات اللي كسر إنكار نبيل، ورسالة الشفرة اللي كشفت طبيعة العلاقة الحقيقية بين الاتنين، والتناقض في مسار التهديد القانوني اللي أثبت إن نبيل تدخل شخصيًا بدل المحامي الرسمي.',
      ]
    },
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: سجل المكالمة، الرسالة المفكوكة، وتناقض مسار التهديد القانوني، قبل ما تتهم.'
    },
    bad: {
