...
const CASE_LAST_COLUMN = {
  ...
  evidence: [
    ...
    { id:'building_entry_log', tag:'من سجل زوار المبنى', crit:true, title:'دخول نبيل الفعلي لمبنى الجريدة', img: IMG_BASE_LASTCOLUMN + 'evidence-entrylog.jpg',
      short:'سجل الاستقبال وكاميرا اللوبي يثبتان دخول نبيل شخصيًا ليلة الوفاة',
      full:'سجل زوار مبنى الجريدة وكاميرا اللوبي بيوضحوا دخول نبيل شخصيًا في نفس الليلة، بعد المكالمة بساعة تقريبًا، رغم ادّعائه إنه كان خارج القاهرة تمامًا — ده أول دليل يثبت وجوده الفعلي في المبنى، مش بس اتصاله.',
  ...
  endings: {
    ...
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: الفحص الطبي الشرعي، دخوله الفعلي للمبنى، وأثر الكوب، قبل ما تتهم.'
    },
    bad: {
