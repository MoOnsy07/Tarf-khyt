...
const CASE_LAST_COLUMN = {
  ...
  evidenceCombinations: [
    ...
    { parts:['toxicology_reexam','nabil_call_log'], resultId:'office_cup_trace' },
  ],
  ...
  conclusiveEvidenceIds: ['toxicology_reexam', 'office_cup_trace', 'lawyer_contradiction', 'decoded_warning'],
    ...
    questions: [
      {
        ...
        options: [
          { id:'a', text:'الفحص الطبي الشرعي كشف مادة مؤثرة على القلب في دم طارق + أثرها على كوب في مكتبه يحمل بصمات نبيل + سجل المكالمة والتناقض في مسار التهديد القانوني اللي أثبتوا زيارته الشخصية' },
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        ...
        'اللي قفل الدائرة كان الفحص الطبي الشرعي الإضافي اللي كشف المادة في دم طارق، وأثرها على كوب القهوة في مكتبه اللي حمل بصمات نبيل، وسجل المكالمة والتناقض في مسار التهديد القانوني اللي أثبتوا تدخله الشخصي المباشر قبل الوفاة.',
      ]
    },
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: الفحص الطبي الشرعي، أثر الكوب، والتناقض في مسار التهديد القانوني، قبل ما تتهم.'
    },
    bad: {
