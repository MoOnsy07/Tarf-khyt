...
const CASE_OLD_PHOTO = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأن نعيم شريك عمل وده يكفي كدافع، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأن أدهم كان له خلاف مع أبوه، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان شريك في الجريمة من البداية، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'كان ناسي الموضوع تمامًا لحد ما شاف الصورة، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'الصورة اللي حملت الحقيقة 20 سنة',
      paragraphs:[
...
(() => {
  ...
  c.endings.partial.hint = 'اجمع على الأقل 3 أدلة من: خلاف نعيم، كونه آخر شخص مع كمال، واعتراف رمزي كشاهد، قبل ما تتهم.';
