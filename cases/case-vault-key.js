...
const CASE_VAULT_KEY = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه جامع تحف وده يكفي كدافع، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'لأن عمر رئيس الأمن وده يخليه مشبوه تلقائيًا، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'فارس خمّن الكود بالصدفة، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'عمر رئيس الأمن هو اللي سرّب الكود مباشرة لفارس، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'الزاوية العمياء فضحت كل حاجة',
      paragraphs:[
...
(() => {
  ...
  c.endings.partial.hint = 'اجمع على الأقل 4 أدلة من: غياب فارس، مسار الزاوية العمياء، واعتراف ليلى ببيع الكود، قبل ما تتهم.';
