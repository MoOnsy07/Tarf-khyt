...
const CASE_NILE_CRUISE = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه شريك عمل وده يكفي كدافع، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'لأن ياسمين استفادت ماليًا من التأمين، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'منصور قفز بنفسه بسبب أزمة نفسية، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'ياسمين هي اللي دبّرت الاختفاء بالكامل، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'نافذة الكابينة كشفت الجريمة',
      paragraphs:[
