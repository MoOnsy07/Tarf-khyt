  ...
  suspects: [
    {
      ...
      confrontations:{
        aunt_testimony:'كنت عند خالتي طول اليوم ده، ده اللي حصل بالظبط.',
        jealousy_note:'أنا معرفش حاجة عن غيرة ياسمين، سمعت عنها بعد الأزمة بس.',
        photo_analysis:'الصورة دي مركبة، ده مش أنا في الخلفية دي خالص.'
      }
    },
    {
      ...
      confrontations:{
        ...
        source_trace:'الرقم ده مش بتاعي، ممكن يكون حد استخدم بياناتي من غير علمي.',
        photo_analysis:'الخلفية دي كانت عندي، بس مش معناه إني أنا اللي ركبت الصورة.',
        contradiction_noted_rumor:'قلت كذا حد كان شايف الصورة دي، مش قصدي أكدب عليك.'
      }
    },
    {
      ...
      confrontations:{
        source_trace:'أنا استلمت الصورة من رقم جديد، ونشرتها لأني صدقتها بس.',
        contradiction_noted_rumor:'أنا مالي بمصدر الصورة، أنا بس أول واحدة شافتها ونشرتها.'
      }
    },
    {
