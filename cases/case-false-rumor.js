...
const CASE_FALSE_RUMOR = {
  ...
  suspects: [
    ...
    },
    {
      ...
      questions:[
        ...
        { q:'التحليل الفني لقى إن جزء من الخلفية جاي من صورة قديمة كانت متداولة في نطاق ضيق. الصورة دي كانت عندك؟', requires:['photo_analysis'],
  ...
  contradictionPuzzle: {
    ...
    statements: [
      ...
      { id:'st3', text:'الصورة المنتشرة فيها اختلافات واضحة في الإضاءة وحواف القص.', source:'دليل: الصورة المنتشرة' },
    ...
    questions: [
      {
        ...
        options: [
          { id:'a', text:'التحليل أثبت الفبركة + سجل الرقم ربط أول إرسال بجهازها + التناقض بين إنكارها والسجل الرقمي' },
          { id:'b', text:'لأنها خطيبة سابقة لخطيب سلمى بس، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'لأنها اتلعثمت أثناء الاستجواب، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنها بكت أثناء الاستجواب، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأنها بنت طيبة معروفة في القرية، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
    ],
