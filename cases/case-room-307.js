...
const CASE_ROOM_307 = {
  ...
  coverImg: IMG_BASE_ROOM307 + 'room307-cover.jpg',
  difficulty: 'صعبة',
  estMinutes: 37,
  ...
  briefing: {
    heroImg: IMG_BASE_ROOM307 + 'room307-cover.jpg',
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الحقيقة أبعد من الخناقة الزوجية',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: خلافه المالي، سجل المكالمات، وكاميرات اللوبي، قبل ما تتهم.'
    },
    bad: {
