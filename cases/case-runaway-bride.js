...
const CASE_RUNAWAY_BRIDE = {
  ...
  evidence: [
    ...
    { id:'waleed_car_seen', tag:'من كاميرات المدخل', crit:true, title:'عربية وليد عند مدخل النادي', img: IMG_BASE_RUNAWAYBRIDE + 'evidence-car.jpg',
      short:'كاميرا المدخل صورت عربية وليد داخلة النادي الساعة تسعة بالليل',
      full:'كاميرا مراقبة مدخل النادي صورت عربية مسجلة باسم وليد وهي داخلة وقت الحفل، رغم إنكاره الكامل لوجوده في المكان.',
    ...
    { id:'nour_hiding_location', tag:'من تحقيق ميداني', crit:true, title:'مكان اختباء نور', img: IMG_BASE_RUNAWAYBRIDE + 'evidence-hideout.jpg',
      ...
      full:'التحقيق الميداني كشف إن نور مش مفقودة أو مخطوفة — هربت بنفسها بعد ما وليد هددها مباشرة إنها لو كملت الفرح هيأذي كريم، فقررت تختفي مؤقتًا عشان تحمي خطيبها وتجمع أدلة ضد وليد بمساعدة خالتها.',
  ...
  investigationActions: [
    {
      ...
      requires:['nour_had_suspicion','waleed_car_seen'], resultEvidenceIds:['nour_hiding_location'],
      successText:'التحقيق الميداني قاد لبيت خالة نور، حيث تبين إنها مختبئة هناك بأمان.'
    },
  ],

  correctSuspectId: 'waleed_partner',
  conclusiveEvidenceIds: ['waleed_car_seen', 'financial_dispute_confirmed', 'nour_had_suspicion', 'nour_hiding_location'],
    ...
    questions: [
      {
        ...
        options: [
          { id:'a', text:'وليد كذب في حجة غيابه وكاميرا المدخل أثبتت وجوده فعليًا + الخلاف المالي وفّر الدافع + نور هربت بنفسها بعد تهديد مباشر ليها' },
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'العروسة اللي هربت عشان تحمي مش عشان تهرب',
      paragraphs:[
        'نور ماكانتش هاربة من الزواج — كانت بتحمي كريم من تهديد مباشر من وليد، اللي هددها إنه لو الفرح كمل هيأذي كريم بسبب خلاف مالي قديم بينهم. قررت تختفي مؤقتًا في بيت خالتها عشان تجمع أدلة ضد وليد من بعيد.',
        'اللي قفل الدائرة كان تناقض حجة غياب وليد مع كاميرا المدخل، والخلاف المالي اللي وفّر الدافع الحقيقي، وشهادة دينا عن الأوراق اللي لقتها نور، والتحقيق الميداني اللي كشف مكان اختبائها الآمن.',
      ]
    },
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: كاميرا المدخل، الخلاف المالي، شك نور، ومكان اختبائها، قبل ما تتهم.'
    },
    bad: {
