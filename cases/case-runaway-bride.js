...
const CASE_RUNAWAY_BRIDE = {
  ...
  evidence: [
    ...
    { id:'gas_station_id', tag:'من محطة بنزين قريبة', crit:true, title:'موظف المحطة يتعرف على وليد شخصيًا', img: IMG_BASE_RUNAWAYBRIDE + 'evidence-gasstation.jpg',
      short:'موظف محطة بنزين قريبة من النادي يؤكد رؤية وليد شخصيًا ينزل من نفس العربية',
      full:'موظف محطة بنزين على بعد دقايق من النادي أكد إنه شاف وليد شخصيًا ينزل من العربية ويشتري سجاير قبل الحفل بساعة تقريبًا، وتعرّف عليه من كارت الدفع باسمه. ده بيربط وليد نفسه بالعربية، مش بس رقم لوحتها.',
    ...
    { id:'nour_voice_note', tag:'من نسخة احتياطية لهاتف نور', crit:true, title:'رسالة نور الصوتية عن التهديد', img: IMG_BASE_RUNAWAYBRIDE + 'evidence-voicenote.jpg',
      short:'رسالة صوتية سجلتها نور بنفسها بتشرح تهديد وليد المباشر بالتفصيل',
      full:'نسخة احتياطية من هاتف نور فيها رسالة صوتية سجلتها بنفسها قبل اختفائها بساعات، بتشرح فيها إن وليد هددها مباشرة إنه لو الفرح كمل هيأذي كريم بسبب الخلاف المالي، ولذلك قررت تختفي مؤقتًا لحمايته.',
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        'نور ماكانتش هاربة من الزواج — كانت بتحمي كريم من تهديد مباشر من وليد، اللي هددها إنه لو الفرح كمل هيأذي كريم بسبب خلاف مالي قديم بينهم. سجّلت رسالة صوتية بنفسها بتشرح التهديد، وقررت تختفي مؤقتًا في بيت خالتها لحد ما توصل الحقيقة لمين يقدر يحميها.',
