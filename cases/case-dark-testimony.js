...
const CASE_DARK_TESTIMONY = {
  ...
  evidence: [
    ...
    { id:'contradiction_noted_dark', tag:'من تحليل التناقضات', crit:true, title:'تناقض بين كلام كريم ووصف الضيف', img:null,
      ...
      full:'كريم قال إنه كان قاعد على ترابيزته طول الليل تقريبًا، بس ضيف تاني وصف لسامح راجل طويل بخاتم فضي كبير جوه الجنينة الجانبية قبل الحادثة بدقايق — وصف بيتطابق معاه تمامًا. الاتنين مايقدروش يكونوا صح مع بعض.',
  ...
  contradictionPuzzle: {
    enabled: true,
    tabLabel: 'تناقضات',
    introText: 'قارن التصريحات دي كويس. اتنين منها بيتعارضوا مع بعض بشكل واضح.',
    ...
    statements: [
      ...
      { id:'st3', text:'"كان عندي خناقة قصيرة مع صاحبي على حجز الطاولات، بعدها رحت أساعد في الموقف."', source:'عمر — في الاستجواب' },
