...
const CASE_DARK_TESTIMONY = {
  ...
  contentWarning: 'القضية دي بتتعامل مع موضوع اعتداء جنسي كجزء من خط الأحداث. مفيش أي وصف صريح أو مشاهد فعلية — التركيز بالكامل على التحقيق وجمع الأدلة والوصول للعدالة. لو الموضوع حساس بالنسبالك دلوقتي، قدرك تسيب القضية دي وترجع لها وقت تاني.',
  ...
  briefing: {
    ...
    text2: 'الشك وقع بسرعة على "عمر"، صديق العريس، لأنه كان قريب من نفس الاتجاه بعدها بدقايق. المشكلة؟ محدش فحص القصة صح. مهمتك مش إنك تشكك في دينا — شهادتها حقيقية وصادقة. مهمتك إنك توصل للشخص الصح اللي هي فعلاً بتوصفه.',
    meta: [
  ...
  suspects: [
    {
      ...
      questions:[
        ...
        { q:'في حاجة تانية فاكراها ممكن تفرق معانا؟',
          a:'"فيه صوت خاتم اتخبط في حاجة معدنية وهو قريب مني... مش متأكدة أوي من التفصيلة دي، بس هي اللي فاكراها."' },
      ]
    },
    {
    ...
    },
    {
      ...
      questions:[
        ...
        { q:'حد قاعد معاك يأكد كلامك؟',
          a:'(بيتردد) "مش متأكد مين كان قاعد بالظبط، كنت بتنقل بين الترابيزات شوية."' },
        { q:'سمعنا إن في شكوى قبل كده من بنت تانية في مناسبة سابقة؟', unlockId:'pastcomplaint',
          a:'(بيتوتر واضح) "ده كلام فاضي، محدش قال حاجة رسمية، ناس بتحب تتكلم بس."' },
      ]
    },
    {
      ...
      questions:[
        { q:'مين كان مسؤول عن الجنينة الجانبية بالليل؟',
          a:'"أنا كنت المفروض أراقبها، بس انشغلت في الصالة الرئيسية أكتر من نص ساعة."' },
    ...
    },
    {
      ...
      questions:[
        ...
        { q:'تعرف حاجة عن اللي حصل؟',
          a:'"سمعت لما الصوت اتعلى بعد شوية، بس كنت بعيد عند الباب، ماشفتش حاجة."' },
      ]
    },
  ],
  ...
  evidence: [
    ...
    { id:'witness', tag:'من شهادة ضيف تاني', crit:true, title:'وصف ضيف لشخص قرب الجنينة', img:null,
    ...
    { id:'pastcomplaint', tag:'من التحقيق الرقمي', crit:true, title:'شكوى سابقة غير رسمية ضد كريم', img:null,
      ...
      full:'في مناسبة سابقة، فيه بنت تانية اشتكت من تصرف مشابه من كريم، بس الشكوى اتقفلت من غير أي إجراء رسمي وقتها. النمط ده بيدعم الشك فيه بقوة.',
    ...
    { id:'cam_verified', tag:'من تحليل الكاميرات', crit:true, title:'تأكيد موثّق لتوقيت عمر في الموقف', img:null,
      ...
      full:'مراجعتك الشخصية لتايم لاين كاميرا الموقف أكدت إن عمر كان فعلاً هناك الساعة 11:15 مساءً — نفس لحظة الحادثة بالضبط. ده مش كلامه بس، ده تأكيد مستقل وموثّق بالطابع الزمني.',
  ...
  cameraPuzzle: {
    enabled:true,
    introText:'سجل كاميرا موقف السيارات بيغطي من الساعة 9 مساءً لحد 12 بالليل. دوّر على اللحظة اللي عمر ظاهر فيها بيساعد سواق يرجّع عربية — بالظبط وقت الحادثة المُبلّغ عنه (11:15 مساءً).',
    resultText:'ظبطت اللحظة الصح. الطابع الزمني على الكاميرا بيوضح عمر واقف في الموقف الساعة 11:15 مساءً بالظبط — نفس دقيقة وقوع الحادثة تمامًا. ده تأكيد موثّق لمكانه، مش مجرد كلامه.',
  ...
  conclusiveEvidenceIds: ['ring', 'witness', 'pastcomplaint', 'cam_verified'],
  ...
  endings: {
    ...
    partial: {
      ...
      paragraphs:[
        'التحقيق بيتجه صح ناحية كريم، وعمر اتبرّأ من الشبهة رسميًا في الوقت الحالي. بس الأدلة اللي جمعتها لسه مش كافية تقفل القضية رسميًا وتقدّم اتهام قانوني كامل.',
      ],
