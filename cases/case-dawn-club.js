    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان ناوي يقتله من البداية عشان يستولي على الصفقة بالكامل، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'كان بيحاول يحمي نفسه من عمرو فقط، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
