...
const CASE_WAREHOUSE_FIRE = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الحريق اللي خبى الحقيقة بدل ما يمحيها',
      paragraphs:[
...
(() => {
  ...
  c.endings.partial.hint = 'اجمع على الأقل تلات أدلة من: سيارة فريد، مساره لنقطة الاشتعال، والتحويل المالي من حسني، قبل ما تتهم.';
