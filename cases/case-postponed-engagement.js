...
const CASE_POSTPONED_ENGAGEMENT = {
  ...
  suspects: [
    ...
    },
    {
      ...
      questions:[
        ...
        { q:'الكاميرا أثبتت إن معتز ركب عربيتك، وبعدها اتلاقى في مخزن مرتبط بيك. تفسر التسلسل ده إزاي؟', requires:['hassan_p_vehicle_camera','moutaz_rescued_verified_v2'], closesInterrogation:true,
          a:'(بيتوتر) "قابلته فعلًا عشان نتكلم في الدين، وركب معايا. وصلنا ناحية المنطقة الصناعية واتخانقنا، وبعدها سبت المكان. معرفش إزاي اتلاقى جوه المخزن، ومش هاعترف بحاجة لمجرد إن المكان كان مرتبط بعقد قديم."' },
      ]
    },
  ],
  ...
  evidence: [
    ...
    { id:'moutaz_rescued_verified_v2', tag:'نتيجة المداهمة', crit:true, title:'العثور على معتز حيًا في المخزن', img:null,
      short:'المداهمة عثرت على معتز داخل غرفة جانبية مقفولة من الخارج',
      full:'بعد اكتمال قرائن السيارة والملكية وإشارة الهاتف، تمت مداهمة المخزن وعُثر على معتز حيًا داخل غرفة جانبية مقفولة من الخارج، بينما كان هاتفه في مكان منفصل. معتز كان مرتبكًا بعد الاحتجاز وقال إنه خرج لمقابلة شخص بخصوص موضوع مالي ثم لم يستطع المغادرة، لكن حالته وقت الإنقاذ لم تسمح له بتأكيد مين بالضبط أغلق عليه. نتيجة المداهمة تثبت مكان الاحتجاز وتوقيت وجوده هناك، لكنها لا تحسم هوية المسؤول وحدها.',
  ...
  investigationActions: [
    ...
    },
    {
      ...
      successText:'تم العثور على معتز حيًا داخل غرفة جانبية مقفولة من الخارج. المداهمة أثبتت مكان الاحتجاز، لكنها لا تحسم هوية المسؤول وحدها.'
    },
  ],
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه دائن لمعتز وده يكفي كدافع، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأن داليا كانت صديقته السابقة، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'معتز هرب بإرادته من الزواج بسبب الضغط المالي، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'داليا كانت وراء اختفائه بدافع الغيرة، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      ...
      paragraphs:[
        ...
        'شهادة البواب كسرت كذبة حسن، والكاميرا سجلت رقم العربية ومعتز بداخلها، ثم قاد التتبع للمخزن. المداهمة أنقذت معتز وأثبتت مكان الاحتجاز، وبعدها ربط التحقيق بين الدين، حركة العربية، صلة المخزن، وتناقض رواية حسن للوصول للمسؤولية.',
      ]
    },
    partial: {
      stamp:'جزئي', badgeLabel:'القضية اتقفلت — أدلة غير كافية', title:'الشك في مكانه، الإثبات ناقص',
      paragraphs:[
        'معتز اتلاقى واتأنقذ، لكن سلسلة الإثبات على الشخص المسؤول لسه ناقصة. لازم تربط حركة العربية، صلة المخزن، والقرائن المالية قبل ما تعتبر الاتهام محسوم.',
      ],
    ...
    bad: {
      ...
      paragraphs:[
        'معتز اتلاقى واتأنقذ، لكن اتهام {wrongName} ماكانش مدعوم بالسلسلة الكاملة. الإنقاذ أثبت مكان الاحتجاز، مش هوية المسؤول وحدها.',
      ]
    }
  }
};
