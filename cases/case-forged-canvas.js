...
const CASE_FORGED_CANVAS = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الحقيقة طلعت من الممر',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: كاميرا الممر، خلاف الشراكة القديم، ومستندات مصدر اللوحة، قبل ما تتهم.'
    },
    bad: {
