    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه كان حزين في الافتتاح، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأنه اشترى تذكرة دخول متأخرة، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          { id:'a', text:'اعترافه المباشر بالسرقة، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'b', text:'التناقض بين كلامه إنه بعيد عن الإدارة، وظهوره في الممر المؤدي للمكتب وقت الحادثة' },
          { id:'c', text:'شهادة بسمة على المدخل، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'b',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنها مشترية غنية ومحدش هيشك فيها، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'لأنها اعترفت بمكانها بس، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
    ],
