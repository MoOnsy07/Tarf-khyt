...
const CASE_ILLUSION_STARTUP = {
  ...
  suspects: [
    {
      ...
      confrontations:{
        financial_records:'السجلات دي فيها تفاصيل معقدة، مش زي ما إنتوا فاهمينها.',
        return_source:'السوق كان بينمو فعلاً وقتها، الأرباح دي كانت حقيقية.',
        app_status:'التطبيق كان في مرحلة متقدمة فعلاً، كنا قريبين من الإطلاق.',
        ops_manager_hint:'كريم كان بيتكلم مع المستثمرين، ده دوره في الشركة.',
        karim_knew:'كريم كان عنده شكوك، بس أنا طمّنته إن كل حاجة تمام.',
        no_real_revenue:'الأرقام دي معقدة، محتاجة وقت أشرحها صح من غير تسرّع.'
      }
    },
    {
      ...
      confrontations:{
        ops_manager_hint:'كريم هو اللي كان بيتواصل معايا كمستثمرة، مش باسل.'
      }
    },
    {
      ...
      confrontations:{
        ops_manager_hint:'أنا كنت الوسيط مع المستثمرين، بس مكنتش عارف كل حاجة عن الأرقام.',
        karim_knew:'كان عندي شك بسيط، بس باسل طمّنني وأنا صدقته.'
      }
    },
    {
      ...
      confrontations:{
        payment_source:'أنا بس بسجل التحويلات زي ما بتيجي، مش قراري أحدد مصدرها.'
      }
    },
  ],
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه اختفى بعد التوقف عن العائدات، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'لأنه المؤسس وده كافي، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه موظف وده يبعده عن الشبهة، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأنه اعترف بمكانه بس، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'الوهم انكشف',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل 4 أدلة من: ادعاء التطبيق، نمط تحويل الفلوس، والسجلات المفكوكة، قبل ما تتهم.'
    },
    bad: {
