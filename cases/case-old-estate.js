...
const CASE_OLD_ESTATE = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه محروم من الوصية وده يكفي كدافع، وده احتمال منطقي في الظاهر بس مش مبني على ربط حقيقي بين أكتر من دليل' },
          { id:'c', text:'لأن مروان مديون وده أوضح دافع، رغم إن ده مجرد ملاحظة سطحية مش استنتاج مبني على أدلة متعددة متطابقة' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان مخطط للقتل من البداية عشان ياخد نصيب في الوصية، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'كان بيحاول يوقع مروان في المشكلة، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'وريث الظل كشف نفسه',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل 3 أدلة من: شهادة اقترابه من الطبق، استبعاده من الوصية، وحالة السم في الطبق، قبل ما تتهم.'
    },
    bad: {
