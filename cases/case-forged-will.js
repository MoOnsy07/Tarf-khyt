...
const CASE_FORGED_WILL = {
    ...
    questions: [
      {
        ...
        options: [
          ...
          { id:'b', text:'لأنه محاسب فؤاد وده يكفي كدافع، وده تفسير سهل بس مايقفلش القضية من غير دليل يدعمه فعليًا' },
          { id:'c', text:'لأن كريم كان أكتر مستفيد محتمل، وده افتراض وارد بس محتاج دليل مادي يثبته مش مجرد كلام' },
        ],
        correctOptionId:'a',
      },
      {
        ...
        options: [
          ...
          { id:'b', text:'كان بيحاول يساعد رنا تاخد نصيب أكبر، بس ده لوحده مايكفيش كدليل قاطع من غير حاجة تانية تأكده' },
          { id:'c', text:'كان بينفذ تعليمات فؤاد الحقيقية بس بطريقة غير رسمية، ومع كده مفيش أي دليل مادي أو شهادة مباشرة بتربط الكلام ده بلحظة الجريمة نفسها' },
        ],
        correctOptionId:'a',
      },
    ],
  ...
  endings: {
    good: {
      stamp:'القضية اتقفلت', badgeLabel:'القضية اتقفلت — إدانة', title:'التوقيع المقلّد فضح نفسه',
      paragraphs:[
...
(() => {
  ...
  c.endings.partial.hint = 'اجمع على الأقل 4 أدلة من: تحليل الخط، أرشيف التوقيعات، واعتراف نبيل بالدفع، قبل ما تتهم.';
