...
const CASE_BRIBERY = {
  ...
  suspects: [
    {
      ...
      questions:[
        ...
        { q:'ممكن نشوف الموافقة الرسمية دي لحالة الطالب ده؟',
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'حق ملك رجعلها',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: سجل النظام، غياب التبرع، وعلاقات والد زياد، قبل ما تتهم.'
    },
    bad: {
