...
const CASE_ROLE_OF_LIFETIME = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الشخصية "المتوفاة" كانت بتدير كل حاجة',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: معرفته التفصيلية، الرسالة المفكوكة، وتطابق أسلوب الكتابة، قبل ما تتهم.'
    },
    bad: {
