...
const CASE_LAST_CALL = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الحقيقة كانت في التكرار الصوتي',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: خلافه المالي، معرفته بخطة فؤاد، والتحليل الصوتي، قبل ما تتهم.'
    },
    bad: {
