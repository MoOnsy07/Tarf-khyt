...
const CASE_SHIFTING_PAINTING = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الحقيقة كانت تحت السطح حرفيًا',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: بصمة الباب، كاميرا المحل، واعترافه بسماعه عن الاكتشاف، قبل ما تتهم.'
    },
    bad: {
