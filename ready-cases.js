...
(function loadTarafSuspectProfiles(){if(typeof document==='undefined'||document.querySelector('script[data-taraf-suspect-profiles]'))return;const s=document.createElement('script');s.src='suspect-profiles.js?v=20260823-2';s.async=false;s.dataset.tarafSuspectProfiles='1';(document.head||document.documentElement).appendChild(s)})();
