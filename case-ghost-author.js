...
const CASE_GHOST_AUTHOR = {
  ...
  endings: {
    good: {
      stamp:'CASE CLOSED', badgeLabel:'CASE CLOSED — CONVICTION', title:'الحقيقة وراء كل الكلمات',
      paragraphs:[
    ...
    partial: {
      ...
      hint:'اجمع على الأقل تلات أدلة من: المسودة القديمة، تحليل خط اليد، واعترافه الجزئي، قبل ما تتهم.'
    },
    bad: {
