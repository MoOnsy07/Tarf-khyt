/* ============================================================
   ...
   - يدعم Google + رابط دخول بالبريد (Magic Link).
   ============================================================ */
(function(){
  'use strict';
  ...
  const CLOUD_SCRIPT_VERSION = '2026-08-23-1';
  ...
  async function refreshCloudCard(){
    ...
    if(acc){
      ...
      card.innerHTML = `
        ...
        <div class="pf-cloud-account">${escapeHTML(acc.email || acc.id)}</div>
    ...
    card.innerHTML = `
      ...
      <div class="pf-cloud-status" id="pf-cloud-status">هنبعتلك رابط آمن على الإيميل — من غير باسورد.</div>`;
